...
1. **You made them, or they are yours to share.** You drew, painted, rendered, photographed or
   otherwise made every picture in the pack, or every picture is CC0 or under a licence that lets
   you share it this way, and you have checked that yourself rather than assumed it.
2. **They are not taken from anywhere.** Not from another app, not from a game, not from a stock
   library, not from someone's portfolio, not scraped from a search. "I found it online" is not a
   licence.
...
## What the pictures must not contain
...
9. **No hate.** No slurs, no hate symbols, nothing attacking or demeaning people for their race,
   ethnicity, nationality, religion, caste, sex, gender, sexual orientation, disability or any
   other characteristic like these.
10. **No gore or shock content.** No graphic violence, mutilation, real injury or death.
11. **No harassment of anyone.** Nothing aimed at a particular person, no personal information
    about anyone, no picture of someone who has not agreed to be in it. A recognisable real
    person needs their permission.
12. **Nothing illegal, and nothing that helps with it.** Including instructions, promotion or
    branding for weapons, drugs, or anything else that is against the law where you or the people
    using FolderSkin are.
13. **Nobody else's brand.** No logos, trade marks or characters that belong to someone else, and
    nothing designed to look like an official pack from a company or person who has not asked for
    one.
14. **Nothing deceptive in the files.** The files are pictures. Nothing hidden in them, nothing
    that pretends to be something else, nothing that tries to mislead the checks.
