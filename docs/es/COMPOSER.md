...
![El editor: un insecto de la biblioteca de iconos estampado en una carpeta azul, con la búsqueda de iconos al lado y Guardar y aplicar debajo](../images/composer.webp)
...
añadidas desde un archivo ([SKINS.md](SKINS.md)). El documento son datos simples en
