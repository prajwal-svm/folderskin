...
![L'éditeur : un insecte tiré de la bibliothèque d'icônes, incrusté dans un dossier bleu, avec la recherche d'icônes à côté et Enregistrer et appliquer en dessous](../images/composer.webp)
...
contrairement aux illustrations ajoutées depuis un fichier ([SKINS.md](SKINS.md)). Le document est
