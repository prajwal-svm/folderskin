...
export function StudioSettings({
  ...
  return (
    <Modal
      ...
      sub="FolderSkin has no server. Skins are generated by the Local Model on your machine, or by the provider you pick with your own key and billed to your account."
      onClose={onClose}
    >
      <ProviderKeys
        catalogue={catalogue}
