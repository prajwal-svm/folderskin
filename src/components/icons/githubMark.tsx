/**
 * GitHub's own mark (Octicons' `mark-github`, MIT), filled in the text colour: for the places that
 * name GitHub itself, where a drawn stand-in reads as a different logo.
 */
